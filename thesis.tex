...
\documentclass[english,seminar,declaration]{KITthesis}
...
\include{Content/2-CurrentApplications}
\include{Content/3-ControlOfRoboticSystem}
\include{Content/4-Future}
